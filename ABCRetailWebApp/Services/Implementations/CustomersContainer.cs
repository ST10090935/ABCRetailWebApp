// File: Services/CustomersContainer.cs
using System.Threading.Tasks;
using Microsoft.Azure.Cosmos;

namespace ABCRetailWebApp.Services
{
    public class CustomersContainer : ICustomersContainer
    {
        public Container Instance { get; }

        public CustomersContainer(CosmosClient cosmosClient, string databaseName, string containerName)
        {
